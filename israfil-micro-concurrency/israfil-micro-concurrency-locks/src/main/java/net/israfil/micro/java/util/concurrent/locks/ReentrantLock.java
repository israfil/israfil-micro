...
import net.israfil.micro.java.util.concurrent.helpers.FIFOWaitQueue;
import net.israfil.micro.java.util.concurrent.helpers.Utils;
import net.israfil.micro.java.util.concurrent.helpers.WaitQueue;
 ...
 */
public class ReentrantLock implements Lock, CondVar.ExclusiveLock {
    ...
    static abstract class Sync {
        ...
        public boolean hasQueuedThreads() {
            throw new RuntimeException("Unsupported: Use FAIR version");
        }
        ...
        public Vector getQueuedThreads() {
            throw new RuntimeException("Unsupported: Use FAIR version");
        }
        ...
        public void lock() {
            ...
            synchronized (this) {
                if (owner_ == null) {
                    ...
                    boolean wasInterrupted = false; //Thread.interrupted();
                    try {
                        while (true) {
                            try {
                                wait();
    ...
    final static class FairSync extends Sync implements WaitQueue.QueuedSync {
        ...
        public synchronized Vector getQueuedThreads() {
     ...
     */
    protected Vector getQueuedThreads() {
     ...
     * @throws NullPointerException if the condition is null
     */
    protected Vector getWaitingThreads(Condition condition) {
