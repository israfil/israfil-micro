...
package net.israfil.micro.java.util.concurrent.helpers;

import net.israfil.micro.java.util.TimeUnit;
import net.israfil.micro.java.util.concurrent.locks.Condition;
...
public final class Utils {
    ...
    private final static NanoTimer nanoTimer = new MillisProvider();
