...
package net.israfil.micro.java.util;
...
/**
  ...
  * net.israfil.micro.java.util.concurrent.Lock lock} is not available:
  *
  * <pre>  Lock lock = ...;
...
public abstract class TimeUnit {
    ...
    public static TimeUnit[] values() {
    	TimeUnit[] tu = new TimeUnit[values.length];
     ...
     * method (see {@linkk BlockingQueue#poll BlockingQueue.poll})
     * using:
     *
